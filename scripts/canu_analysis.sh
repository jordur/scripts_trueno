...
#		sbatch -p q-low -n 6 ~/scripts/trimmomatic.sh
#		echo $jid6 > /home/ibv/jdurban/MinION/$sample/jobs/job6.txt
#		job6=`awk '{print $NF}' /home/ibv/jdurban/MinION/$sample/jobs/job6.txt`
	# Prinseq #
#		jid6=$(sbatch -p q-low -n 6 ~/scripts/prinseq_pre.sh)
#                sbatch -p q-low -n 6 ~/scripts/prinseq_pre.sh
#                echo $jid6 > /home/ibv/jdurban/MinION/$sample/jobs/job6.txt
#                job6=`awk '{print $NF}' /home/ibv/jdurban/MinION/$sample/jobs/job6.txt`
...
#		jid10=$(sbatch -p q-low --dependency=afterany:$job9 ~/scripts/spades.sh)
		jid10=$(sbatch -p q-low ~/scripts/spades.sh)
...
jid6=$(sbatch -p q-low --dependency=afterany:$job4 ~/scripts/nanopolish_consensus.sh)
echo $jid6 > /home/ibv/jdurban/MinION/$sample/jobs/job6.txt
job6=`awk '{print $NF}' /home/ibv/jdurban/MinION/$sample/jobs/job6.txt`
}
...
## STOP Copy files from scratch-global ##
