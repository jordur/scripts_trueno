...
TRINITYPATH="/home/ibv/jdurban/programas/trinityrnaseq_r20140717/"
...
##################################################################################################################################
TRINITYPBSPATH=/home/ibv/jdurban/TRANSCRIPTOMES/results/assembly/Trinity_PBS # set to location of this script

##################################################################################################################################
########  Set cluster specific name for compute node local filesystem
##################################################################################################################################
MEMDIRIN="\$SCRATCH"  # available on Barrine  
...
MODTRINITY="
 $NEWPATH;
 export TRINITYPATH="/home/ibv/jdurban/programas/trinityrnaseq_r20140717";
 $MODTRINITY
"
##################################################################################################################################
##################################################################################################################################
